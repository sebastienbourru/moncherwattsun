  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <a href="/" class="navbar-logo" style="display:inline-flex;">
          <div class="logo-icon">
      ...
      <!-- Outils -->
      <div>
        <p class="footer-heading">Outils</p>
        <ul class="footer-links">
          <li><a href="/simulateur">
      ...
      <div>
        ...
        <div style="margin-top:24px; padding:16px; background:rgba(245,158,11,.1); border-radius:10px; border:1px solid rgba(245,158,11,.2);">
          <p style="color:rgba(255,255,255,.6); font-size:.78rem; line-height:1.6; margin:0;">
            <strong style="color:var(--sun);">Sources utilisées</strong><br>
            Simulateur : PVGIS (JRC — Commission Européenne*). Aides : ADEME, France Rénov. Pros : API Sirene INSEE. Stats : RTE Éco2mix.<br>
            <span style="color:rgba(255,255,255,.35); font-size:.72rem;">* re.jrc.ec.europa.eu</span>
          </p>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <p>© <?= $current_year ?> Mon cher WattSun — Tous droits réservés</p>
